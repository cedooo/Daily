 ...
 * 
 */
public class WeeklyReportTemplate implements IReportTemplate {
	...
	public WeeklyReportTemplate() {
		reportQuery = new ReportQuery(WeeklyReportTemplate.class);
